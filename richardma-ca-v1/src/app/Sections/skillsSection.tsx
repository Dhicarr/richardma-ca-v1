...
const SkillsSection = ({sectionClass}:ComponentProps): JSX.Element => {
  ...
  const skillsClass="flex flex-wrap mt-1 pr-3 w-fit justify-center md:justify-normal"

  return (
    <main id="skill" className={sectionClass}>
      <div className="text-3xl font-semibold md:font-normal md:weight md:text-4xl ">
        <span className="title-shadow w-fit relative">Skills <span className="text-line"/></span>
      </div>
